...
export default function Sidebar({ isExpanded, onToggle }: SidebarProps) {
  ...
  return (
    <aside
      className={`fixed left-0 top-20 h-[calc(100dvh-5rem)] bg-white dark:bg-slate-900 border-r border-gray-200 dark:border-slate-700 z-30 flex flex-col transition-all duration-300 ease-in-out shadow-sm ${
